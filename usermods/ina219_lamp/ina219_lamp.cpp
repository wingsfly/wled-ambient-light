...
class Ina219LampUsermod : public Usermod {
  ...
  public:
    ...
    void loop() override {
      ...
      lastRead = millis();
      uint16_t raw;
      if (read16(0x01, raw)) currentA = Ina219Lamp::currentAmps(raw);
    ...
    void addToJsonInfo(JsonObject &root) override {
      ...
      // Expose the compiled calibration so a board/firmware mismatch is visible.
      JsonArray shunt = user.createNestedArray(F("INA219 shunt"));
      shunt.add(serialized(String(Ina219Lamp::SHUNT_OHMS * 1000.0f, 3))); shunt.add(F(" mOhm"));
      // AI: end
    }
